      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 32 }}>
            ...
            <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 22, color: '#2d1a4a', fontWeight: 400, marginTop: 12, letterSpacing: '-.02em' }}>Join Muse</div>
            <div style={{ fontSize: 13, color: '#9070b0', marginTop: 4, fontWeight: 300 }}>Your garden awaits</div>
          </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                  <div>
                    ...
                    <input value={firstName} onChange={e => setFirstName(e.target.value)}
                      placeholder="Aria" required autoFocus style={input}
          ...
          {step === 'otp' && (
            <form onSubmit={handleOtp}>
              <p style={{ fontSize: 13, color: '#7a5a9a', marginBottom: 16, fontWeight: 300, lineHeight: 1.6, textAlign: 'center' }}>
              ...
              <button type="button" onClick={() => { setStep('info'); setError(''); setCode(''); }} style={ghost}>
                ← Back
              </button>
            </form>
          )}
